...
[![Parity Sample](https://github.com/testparity/phpunit-sample/actions/workflows/parity.yml/badge.svg)](https://github.com/testparity/phpunit-sample/actions/workflows/parity.yml)

This repository is a focused Parity demo for PHPUnit. It intentionally separates aggregate file coverage from matching-test coverage, which is the core Parity use case.
...
| --- | --- | ---: | ---: | ---: | --- |
| `code/src/InvoiceCalculator.php` | `code/tests/InvoiceCalculatorTest.php` | 70% | 40% | 2 | Overall coverage looks acceptable, but most covered lines come from incidental tests. |
| `code/src/DiscountPolicy.php` | `code/tests/DiscountPolicyTest.php` | 90% | 90% | 2 | The matching test owns nearly all of the file's coverage. |
...
- `InvoiceCalculator.php`: `minimum-coverage = 70%`, `matched-coverage = 40%`, `coverage-attribution = 3|2`.
